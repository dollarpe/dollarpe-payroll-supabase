        ...
        <section className="py-10 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li>This website’s pages and content are for your general information and use only. It is subject to change without prior notice.</li>
              ...
              <li>( Gigpay  is a brand owned and operated by DollarPe Technologies Private Limited .)</li>
              ...
              <li>Your use of this website and any dispute arising out of such use of the website is subject to the exclusive jurisdiction of the courts of Delhi, India .</li>
            </ul>
            <h2 className="text-2xl font-bold mb-2 mt-8">Acceptance of Terms through Use</h2>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li>The data we collect from you are stored in our system servers and will be treated with the utmost confidentiality. Your personal information will be used only by Gigpay (operated by DollarPe Technologies Private Limited)  for business transactions that require your information to complete the process.</li>
              <li>Gigpay  reserves the right to verify the authenticity of the information or documents you provide.</li>
            </ul>
          </div>
        </section>
      </main>
