        ...
        <section className="py-10 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>2.2 <span className="font-semibold">Transaction Information:</span> details of payout transactions processed through our service.</li>
              <li>2.3 <span className="font-semibold">Device and Usage Information:</span> IP address, browser type, operating system, and interactions with our website and services.</li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>3.5 Improve our services and develop new features.</li>
            </ul>
