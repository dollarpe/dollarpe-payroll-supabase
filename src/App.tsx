  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex flex-col md:flex-col gap-5 items-center justify-between">
            <div className='flex flex-col items-center justify-center'>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed text-center max-w-2xl">
                Transform outdated payroll practices and build a better workplace for your business with Gigpay.
              </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-100/50 text-center">
        ...
        <p className='text-xl text-gray-600 max-w-3xl mx-auto mb-16 text-center'>Create custom leave types, allow employees to apply for leaves, approve or reject leaves, manage attendance - all from within Gigpay.</p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-100/50 text-center">
        ...
        <p className='text-xl text-gray-600 max-w-3xl mx-auto mb-16 text-center'>Build new feature on top of an already powerful platform and make Gigpay work the way you want.</p>
      ...
      <section id="testimonials" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                quote: "Gigpay has completely transformed our payroll process. What used to take days now takes hours. The compliance features give us peace of mind.",
                author: "Dhruv Vats",
                role: "HR Director",
              ...
              {
                quote: "Switching to Gigpay was the best decision for our growing startup. The automation saves us countless hours and the support team is incredibly responsive.",
                author: "Sujith Sizon",
                role: "CEO",
                company: "Audace LLC"
              }
